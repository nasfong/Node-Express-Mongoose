...
var createData = function (req, res) {
    var _a = req.body, name = _a.name, permission = _a.permission;
    var role = new role_model_1["default"]({ name: name, permission: permission });
    role.populate('permission');
    try {
        return role
            .save()
            .then(function (role) { return res.status(200).json({ data: role }); })["catch"](function (validate) { return res.status(201).json({ data: validate.errors }); });
    }
    catch (error) {
...
var readAllData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, role_model_1["default"]
                        .find()
                        .populate('permission')
                    // .select('-__v')
                ];
            case 1:
                roles = _a.sent();
                // .select('-__v')
                return [2 /*return*/, res.status(200).json({ data: roles })];
            case 2:
                error_1 = _a.sent();
...
var readData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                role = _a.sent();
                return [2 /*return*/, role ? res.status(200).json({ data: role }) : res.status(404).json({ status: 'Not found' })];
            case 3:
                error_2 = _a.sent();
...
var updateData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, name, permission;
    return __generator(this, function (_b) {
        id = req.params.id;
        _a = req.body, name = _a.name, permission = _a.permission;
        return [2 /*return*/, role_model_1["default"]
                .findById(id)
                .then(function (role) {
                if (role) {
                    role.set({ name: name, permission: permission })
                        .populate('permission');
                    return role
                        .save()
                        .then(function (role) { return res.status(200).json({ data: role }); })["catch"](function (validate) { return res.status(201).json({ data: validate.errors }); });
...
var deleteData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        id = req.params.id;
        return [2 /*return*/, role_model_1["default"].findByIdAndDelete(id)
                .then(function (role) { return role ? res.status(200).json({ message: 'Deleted' }) : res.status(404).json({ message: 'Not found' }); })["catch"](function (error) { return res.status(500).json({ error: error }); })];
    });
}); };
...
var readDropdown = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                roles = _a.sent();
                roles = roles.reduce(function (json, value, index) {
                    json[value._id] = value.name;
                    return json;
                }, {});
                return [2 /*return*/, res.status(200).json(roles)];
            case 2:
                error_3 = _a.sent();
