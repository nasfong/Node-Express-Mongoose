...
var createData = function (req, res) {
    var _a = req.body, name = _a.name, user = _a.user;
    var chat = new chat_model_1["default"]({ name: name, user: user });
    try {
        return chat
            .save()
            .then(function (chat) { return res.status(200).json({ data: chat }); })["catch"](function (validate) { return res.status(201).json({ data: validate.errors }); });
    }
    catch (error) {
        console.log(error);
...
var readAllData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, chat_model_1["default"]
                        .find()
                        .populate('user')
                        .select('-__v')];
            case 1:
                chat = _a.sent();
                return [2 /*return*/, res.status(200).json({ data: chat })];
            case 2:
                error_1 = _a.sent();
...
var readData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                chat = _a.sent();
                return [2 /*return*/, chat ? res.status(200).json({ data: chat }) : res.status(404).json({ status: 'Not found' })];
            case 3:
                error_2 = _a.sent();
...
var updateData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        id = req.params.id;
        return [2 /*return*/, chat_model_1["default"]
                .findById(id)
                .then(function (chat) {
                if (chat) {
                    chat.set({
...
var deleteData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        id = req.params.id;
        return [2 /*return*/, chat_model_1["default"].findByIdAndDelete(id)
                .then(function (chat) { return chat ? res.status(200).json({ message: 'Deleted' }) : res.status(404).json({ message: 'Not found' }); })["catch"](function (error) { return res.status(500).json({ error: error }); })];
    });
}); };
